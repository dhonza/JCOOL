 ...
 * The global minima: n = 2: x* = (8.0240653, 9.1465340), f(x*) = -12.1190083797535 for m = 30.
 *                    n = 5: x* = (8.02491489, 9.15172576, 5.11392781, 7.62086096, 4.56408839), f(x*) = -10.40561723899245 for m = 30.
 * http://www.it.lut.fi/ip/evo/functions/node16.html
 */
@Component(name="Shekel Function")
public class ShekelFunction implements Function {
  ...
  private static double[] beta = {0.806, 0.517, 0.100, 0.908, 0.965, 0.669, 0.524, 0.902, 0.531, 0.876, 0.462,
                                  0.491, 0.463, 0.714, 0.352, 0.869, 0.813, 0.811, 0.828, 0.964, 0.789, 0.360,
                                  0.369, 0.992, 0.332, 0.817, 0.632, 0.883, 0.608, 0.326};


  private static double[][] C = {{9.681, 0.667, 4.783, 9.095, 3.517, 9.325, 6.544, 0.211, 5.122, 2.020},
  ...
  public double valueAt(Point point) {
    ...
    for (int i = 0; i < m; i++) {
      ...
      for (int j = 0; j < n; j++)
        sum2+= (ax[j] - C[i][j]) * (ax[j] - C[i][j]);

      sum1 += 1.0 / (sum2 + beta[i]);
    }
